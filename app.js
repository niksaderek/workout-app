...
const popularExercises = {
  ...
  legs: ['Back Squat', 'Front Squat', 'Goblet Squat', 'Bodyweight Squat', 'Leg Press', 'Machine Squat', 'Hack Squat', 'Bulgarian Split Squat', 'Lunges', 'Step-ups', 'Pistol Squat', 'Wall Sit', 'Jump Squats', 'Romanian Deadlift', 'Hip Thrust', 'Glute Bridge', 'Leg Extension', 'Leg Curl', 'Seated Leg Curl', 'Calf Raises'],
